...
function ModalEditClearanceBooks({
  showModalEditClearanceBooks,
  setShowModalEditClearanceBooks,
  clearanceBookData,
  onEditSuccess,
}) {
    ...
    <>
      <Modal show={showModalEditClearanceBooks} onHide={handleClose} size="lg">
        <Modal.Header closeButton className="justify-content-center">
          <Modal.Title style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Chỉnh Sửa Sách Thanh Lý</Modal.Title>
        </Modal.Header>
            ...
            <Row className="g-3">
              <Col md={4}>
                <Form.Group controlId="formMasachthanhly">
                  ...
                  <Form.Control type="text" value={masachthanhly} disabled className="shadow-sm" />
                </Form.Group>
              </Col>
        ...
        <Modal.Footer className="justify-content-between">
          ...
          <Button variant="primary" onClick={handleEditClearanceBook} className="px-4" disabled={!isEditable}>
            Lưu Lại
          </Button>
        </Modal.Footer>
      </Modal>
