    ...
    <>
      <Modal show={showModalAddUser} onHide={handleClose} size="lg">
        <Modal.Header closeButton className="justify-content-center">
          <Modal.Title style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Thêm Người Dùng</Modal.Title>
        </Modal.Header>
            ...
            <Row className="g-3">
              ...
              <Col md={6}>
                ...
                <Form.Group controlId="formTypereader">
                  ...
                  <Form.Select value={typereader} onChange={(e) => setTypereader(e.target.value)} className="shadow-sm">
