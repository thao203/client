...
import { Box, Typography, Card, CardContent, Pagination, PaginationItem, Grow, Fade, ButtonBase } from '@mui/material';
            ...
            >
              {currentCategories.length > 0 ? (
                currentCategories.map((category, index) => {
                  ...
                  return (
                    <Grow in timeout={600 + index * 150} key={category.madanhmuc}>
                      <motion.div
