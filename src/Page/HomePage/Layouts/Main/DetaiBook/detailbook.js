...
const DetailBook = () => {
  ...
  const handleAddToCart = (cartItem) => {
    try {
      ...
      const existingItem = cart.find((item) => item.masach === cartItem.masach && item.mavitri === cartItem.mavitri);
                ...
                <div className="col-md-8 p-4">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="mb-2">
                          ...
                          <span className="badge bg-warning text-dark">
                            {book.vitri.reduce((total, v) => total + (v.soluongmuon || 0), 0)}
                          </span>
                        </li>
                        <li className="mb-2">
                          <strong>
                    ...
                    <ul className="list-group list-group-flush">
                      {book.vitri.map((v, index) => (
                        <li key={index} className="list-group-item d-flex justify-content-between align-items-center">
                          ...
                          <div>
                            <span className="badge bg-primary me-2">Số lượng còn: {v.soluong_con}</span>
                            <span className="badge bg-warning text-dark">Số lượng mượn: {v.soluongmuon}</span>
                          </div>
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="mt-4 d-flex gap-3">
                    ...
                    <button
                      ...
                      onClick={() => handleShowCart(book.masach, book.tensach, book.vitri || [], book.img)}
                    >
