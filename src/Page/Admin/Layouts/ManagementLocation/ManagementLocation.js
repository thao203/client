        ...
        <div className="row align-items-center justify-content-between g-3">
          ...
          <div className="col-12 col-md-6">
            <div className="row g-2 align-items-center">
              <div className="col-4">
                <select className="form-select" value={selectedCoso} onChange={(e) => setSelectedCoso(e.target.value)}>
              ...
              <div className="col-4">
                <select className="form-select" value={selectedSoke} onChange={(e) => setSelectedSoke(e.target.value)}>
          ...
          <div className="col-12 col-md-3 text-center text-md-end d-flex justify-content-end gap-2">
            <button onClick={handleModalAddLocation} className="btn btn-primary">
              <i className="bi bi-plus-lg me-2" />
              Thêm Vị Trí
            </button>
            <button onClick={handleModalQR} className="btn btn-success">
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      <div className="d-flex gap-2 justify-content-center">
                        <button onClick={() => handleShowDetail(item.mavitri)} className="btn btn-info btn-sm">
                          <i className="bi bi-eye me-1" /> Chi tiết
                        </button>
                        <button onClick={() => handleModalEditLocation(item)} className="btn btn-warning btn-sm">
          ...
          <div className="modal-dialog modal-xl">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button type="button" className="btn-close" onClick={() => setShowModalQR(false)} />
              </div>
