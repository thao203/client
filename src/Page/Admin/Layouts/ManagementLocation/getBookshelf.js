    ...
    const fetchBookshelf = async () => {
      try {
        ...
        const response = await request.get(
          `/api/getBookshelf?coso=${encodeURIComponent(coso)}&soke=${encodeURIComponent(soke)}`
        );
    ...
    <div className="container my-3">
      <div className="card shadow-sm p-3">
        ...
        error ? (
                  ...
                  <div className="card h-100 book-card">
                    {book.img && (
                      <div className="book-image-container">
                        <img src={book.img} className="card-img-top book-image" alt={book.tensach} />
                      </div>
                    )}
          ...
          <div className="alert alert-warning text-center">Không tìm thấy sách nào trên kệ này!</div>
        )}
      </div>
