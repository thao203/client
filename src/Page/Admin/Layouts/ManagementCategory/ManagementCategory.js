      ...
      <div className="container my-4">
        <div className="row align-items-center justify-content-between g-3">
          ...
          <div className="col-12 col-md-3 text-center text-md-end">
            <button onClick={handleModalAddCategory} className="btn btn-primary w-100 w-md-auto">
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      <div className="d-flex gap-2 justify-content-center">
                        <button onClick={() => handleShowDetail(item.madanhmuc)} className="btn btn-info btn-sm">
                          <i className="bi bi-eye me-1" /> Chi tiết
                        </button>
                        <button onClick={() => handleModalEditCategory(item)} className="btn btn-warning btn-sm">
                          <i className="bi bi-pencil me-1" /> Sửa
                        </button>
                        <button
                          onClick={() => handleModalDeleteCategory(item.madanhmuc)}
