...
const Report = () => {
  ...
  const getChartData = () => {
    ...
    const currentItems = bookStats.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
      ...
      <div className="card shadow-lg" style={{ borderRadius: '15px', overflow: 'hidden', background: '#f9f9f9' }}>
        <div className="card-header bg-gradient-primary text-white">
          <div className="d-flex justify-content-between align-items-center">
            <h4 className="mb-0">
              Báo Cáo Thống Kê Sách - Tháng {month}/{year}
            </h4>
        ...
        <div className="card-footer text-muted">Cập nhật: {new Date().toLocaleString('vi-VN')}</div>
      </div>
