          ...
          <Container maxWidth="md" sx={{ py: 6 }}>
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                <GradientTitle variant="h4">Chào mừng đến Thư viện Điện tử UNETI!</GradientTitle>
                <SupportText variant="body1">
                  Khám phá kho tàng tri thức với hàng ngàn tài liệu độc đáo! Chúng tôi ở đây để giúp bạn tận hưởng hành
                  trình học tập và nghiên cứu một cách trọn vẹn nhất. Hãy cùng bắt đầu nào!
                </SupportText>
              </Box>
            </motion.div>
              ...
              <motion.div variants={listItemVariants} initial="hidden" animate="visible">
                <StyledListItem>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      <Box component="span">
                        - Giảng viên: 45 ngày, tối đa 9 cuốn.
                        <br />- Sinh viên: 30 ngày, tối đa 6 cuốn.
                      </Box>
                    }
                  />
                </StyledListItem>
              ...
              <motion.div variants={listItemVariants} initial="hidden" animate="visible">
                <StyledListItem>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      <>
                        Cần thêm thời gian? Nhấn 'Gia hạn' tại 'Lịch sử mượn' – mỗi sách được 1 lần duy nhất.
                        <br />
                        - Giảng viên: 15 ngày.
                        <br />- Sinh viên: 10 ngày.
                      </>
                    }
                  />
                </StyledListItem>
