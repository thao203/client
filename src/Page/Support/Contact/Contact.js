...
function Contact() {
  ...
  const MapComponent = ({ center }) => {
    ...
    return (
      <GoogleMap mapContainerStyle={mapContainerStyle} center={center} zoom={15} options={{ disableDefaultUI: false }}>
            ...
            <Grid container spacing={4} justifyContent="center">
              ...
              <Grid item xs={12} md={4}>
                <motion.div variants={cardVariants} initial="hidden" animate="visible">
                  <StyledCard>
                    <StyledCardMedia component="img" image="uneti_MK.jpg" alt="Hà Nội - Minh Khai" />
                    <CardContent>
              ...
              <Grid item xs={12} md={4}>
                <motion.div variants={cardVariants} initial="hidden" animate="visible">
                  <StyledCard>
                    <StyledCardMedia component="img" image="uneti_LN.jpg" alt="Hà Nội - Lĩnh Nam" />
                    <CardContent>
                      <Typography variant="h5" gutterBottom sx={{ fontWeight: 600 }}>
              ...
              <Grid item xs={12} md={4}>
                <motion.div variants={cardVariants} initial="hidden" animate="visible">
                  <StyledCard>
                    <StyledCardMedia component="img" image="/uneti_ND.jpg" alt="Nam Định Campus" />
                    <CardContent>
                      <Typography variant="h5" gutterBottom sx={{ fontWeight: 600 }}>
                        Cơ sở Nam Định
                      </Typography>
